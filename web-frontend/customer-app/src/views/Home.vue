          ...
          <div class="row justify-content-md-center">
            <div class="col-lg-8">
              <div class="section-title text-center">
                <h2>
                  The real <span>workout</span> starts when you want to stop.
                </h2>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="trainer-item">
                ...
                <p>
                  ...
                  concerning building muscle through weight training &
                  nutrition.
                </p>
              </div>
            </div>
            ...
            <div class="col-lg-7 ml-auto">
              <div class="section-title mb-0">
                ...
                <p>
                  ...
                  and weight to work out if your weight is within a healthy
                  range. A Healthy BMI is considered to be between 20 and 25.
                </p>
              </div>
