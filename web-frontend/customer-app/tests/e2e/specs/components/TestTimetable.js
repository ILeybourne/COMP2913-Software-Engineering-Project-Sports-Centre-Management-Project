describe("TestTimetable", () => {
  ...
  it("Check button labels are correct", () => {
    ...
    cy.get(
      'button[class="fc-resourceTimelineDay-button fc-button fc-button-primary fc-button-active"]'
    ).contains("day");
    cy.get(
      'button[class="fc-resourceTimelineWeek-button fc-button fc-button-primary"]'
    ).contains("week");
  });
