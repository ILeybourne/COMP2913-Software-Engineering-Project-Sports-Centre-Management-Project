...
public interface PaymentService {
    ...
    PayResponseBodyDTO createFromNewCard(Long customer_id, String email, BigDecimal cost, Boolean regularSessionBooking, Integer participants, String username, Boolean isManager, Boolean saveCard) throws StripeException;
